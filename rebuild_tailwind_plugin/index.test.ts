...
test('rebuild_tailwind_plugin_|default', async ()=>{
	...
	try {
		...
		equal(esbuild_cssBundle_text.includes('@import "tailwindcss";'), true)
		equal(esbuild_cssBundle_text.includes('@tailwind base;'), false)
		equal(esbuild_cssBundle_text.includes('@tailwind components;'), false)
		equal(esbuild_cssBundle_text.includes('@tailwind utilities;'), false)
